# USAGE
# python shallownet_trafficsigns.py --training ./datasets/BelgiumTSC_Training --testing ./datasets/BelgiumTSC_Testing --model shallownet_trafficsigns_weights.hdf5
